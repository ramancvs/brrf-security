...
namespace BRRF.IdentityServer.UI
{
    /// <summary>
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(
            ...
            IEventService events, ApplicationDbContext db)
        {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (_authRepository.ValidatePassword(model.Username, model.Password))
                {
        ...
        public async Task<IActionResult> ExternalLoginCallback()
        {
            ...
            //var user = _authRepository.FindByExternalProvider(provider, userId);
            //if (user == null)
            //{
            //    // this sample simply auto-provisions new external user
            //    // another common approach is to start a registrations workflow first
            //    user = _authRepository.AutoProvisionUser(provider, userId, claims);
            //}
